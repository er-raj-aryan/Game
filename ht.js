var WIDTH = innerWidth, HEIGHT = 600;
var aspectRatio = WIDTH / HEIGHT;
var renderer = new THREE.WebGLRenderer({antialias:true}), camera = new THREE.PerspectiveCamera(45, aspectRatio, 0.1, 1000), scene = new THREE.Scene();
...
var BACKGROUND_COLOR = 0xA1E81C , BODY_COLOR = 0xE8791C, HEAD_COLOR = 0xF2290E , score = 0;
...
function init() {
    ...
    new Cube(new THREE.Vector3(1, 1, 1), edgesMaterial, scene, gameCube, true).setPosition(0, 0, 0);

    text.style.position = "fixed";
    text.style.width = 200;
    text.style.height = 100;
    text.innerHTML = "Game Score :- " + score ; 
...
function about(){
    alert("Leadership and learning are indispensable to each other  ")
